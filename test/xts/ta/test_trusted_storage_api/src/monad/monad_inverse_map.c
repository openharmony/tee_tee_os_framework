...
static MonadReversibilityProperty g_groupReverseList[] = {
    ...
    {
        .elementName = "CreatePersistentObject",
        .element = CreatePersistentObject,
        .inverseElementName = "DeletePersistentObject",
        .inverseElement = DeletePersistentObject,
        .isBalanced = 0,
    },
    {
        .elementName = "CreateMultiObject",
        .element = CreateMultiObject,
        .inverseElementName = "DeleteMultiObject",
        .inverseElement = DeleteMultiObject,
        .isBalanced = 0,
    },
    {
        .elementName = "AllocateEnumerator",
        .element = AllocateEnumerator,
        .inverseElementName = "FreeEnumerator",
        .inverseElement = FreeEnumerator,
        .isBalanced = 0,
    },
    {
        .elementName = "AllocateTransientObject",
        .element = AllocateTransientObject,
        .inverseElementName = "FreeTransientObject",
        .inverseElement = FreeTransientObject,
        .isBalanced = 0,
    },
};
...
int DisbalanceGroupElement(MonadReversibilityProperty *list, uint32_t listSize, ActionEntryType element)
{
    ...
    find->isBalanced = GROUP_NOT_BALANCED;
...
int BalanceGroupElementList(IntermediateReprestation *ir)
{
    ...
    uint32_t i;
    for (i = 0; i < listSize; i++) {
        if (list[i].isBalanced == GROUP_NOT_BALANCED) {
