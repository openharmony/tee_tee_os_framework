...
enum TEE_Result_Value {
    ...
    TEE_ERROR_SECFS_BASE                    = 0xFFFF7000, /* base value of error codes                              */
    TEE_ERROR_SECFS_GENERIC                 = 0xFFFF7001, /* generic error of operations                            */
    TEE_ERROR_SECFS_MAC_FAIL                = 0xFFFF7002, /* verify MAC failed in operations                        */
    TEE_ERROR_SECFS_COUNTER_FAIL            = 0xFFFF7003, /* invalid counter in operations                          */
    TEE_ERROR_SECFS_ADDR_FAIL               = 0xFFFF7004, /* addresss check failed in operations                    */
    TEE_ERROR_SECFS_WRITE_FAIL              = 0xFFFF7005, /* failed to write data                                   */
    TEE_ERROR_SECFS_READ_FAIL               = 0xFFFF7006, /* failed to read data                                    */
    TEE_ERROR_SECFS_KEY_NOT_PROGRAM         = 0xFFFF7007, /* key is not provisioned                                 */
    TEE_ERROR_SECFS_RESP_UNEXPECT_MSGTYPE   = 0xFFFF7100, /* incorrect message type in response                     */
    TEE_ERROR_SECFS_RESP_UNEXPECT_BLKCNT    = 0xFFFF7101, /* incorrect message data block count in response         */
    TEE_ERROR_SECFS_RESP_UNEXPECT_BLKIDX    = 0xFFFF7102, /* incorrect message data block index in response         */
    TEE_ERROR_SECFS_RESP_UNEXPECT_WRCNT     = 0xFFFF7103, /* incorrect message data counter in response             */
    TEE_ERROR_SECFS_RESP_UNEXPECT_NONCE     = 0xFFFF7104, /* incorrect message data nonce in response               */
    TEE_ERROR_SECFS_RESP_UNEXPECT_MAC       = 0xFFFF7105, /* incorrect message data MAC in response                 */
    TEE_ERROR_SECFS_FILE_NOT_FOUND          = 0xFFFF7106, /* file not found                                         */
    TEE_ERROR_SECFS_NOSPC                   = 0xFFFF7107, /* not space left for operations                          */
    TEE_ERROR_SECFS_SPC_CONFLICT            = 0xFFFF7108, /* exceeds max space of for this TA                       */
    TEE_ERROR_SECFS_NOT_AVAILABLE           = 0xFFFF7109, /* service not ready                                      */
    TEE_ERROR_SECFS_DAMAGED                 = 0xFFFF710A, /* partition is damaged                                   */
