...
platform_drivers += libhardware_crypto_drv
endif

$(platform_drivers):
	@echo "building platform_drivers=$@ target path $(PLATFORM_DRIVERS_PATH)/$@"
	$(VER) LDFLAGS= $(MAKE) -C $(PLATFORM_DRIVERS_PATH)/$@ ARCH=aarch64 -f $(PREBUILD_HEADER)/.config -f Makefile all
