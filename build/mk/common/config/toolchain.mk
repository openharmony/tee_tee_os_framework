...
ifeq ($(ARCH), arm)
	...
	LIBCOMPILER_RT_BUILTINS := $(TEE_COMPILER_DIR)/lib/clang/$(LLVM_BASEVER)/lib/arm-linux-ohos/libclang_rt.builtins.a
...
ifeq ($(CONFIG_ARM_CORTEX_A53),y)
	...
	LIBCOMPILER_RT_BUILTINS := $(TEE_COMPILER_DIR)/lib/clang/$(LLVM_BASEVER)/lib/aarch64-linux-ohos/libclang_rt.builtins.a
    flags += -march=armv8-a
ifeq ($(CONFIG_ARM_CORTEX_A53),y)
